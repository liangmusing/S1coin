...
#if defined(NDEBUG)
# error "Sheepcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Sheepcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SHC additional fees, %d delta bytes\n",
