...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sheepcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sheepcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sheepcoin transaction") + "\n" +
              "  sheepcoin-tx [options] -create [commands]   " + _("Create hex-encoded sheepcoin transaction") + "\n" +
              "\n";
