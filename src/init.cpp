...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/sheepcoin-project/sheepcoin>";
    const std::string URL_WEBSITE = "<https://sheepcoin.org>";
