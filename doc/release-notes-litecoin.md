...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 lites per kB (0.00001 SHC). This is to prepare for dropping the minimum transaction fee to 0.1 lites per kB (0.0001 SHC) in the next release.
